    ...
    <div className="grid grid-cols-1 md:grid-cols-2">
      ...
      <div>
        ...
        <p>
          ...
          cursus arcu. Cras sodales risus vel arcu iaculis, sed scelerisque diam
          consectetur.
        </p>
        <button
          href="#"
          className="border border-solid border-base-500 rounded-lg py-2 px-5 bg-secondary hover:bg-secondaryDark"
        >
          Join this event!
        </button>
        <div className="space-x-2 flex">
          <p className="space-x-2 py-0.5">Participants: </p>
          <a className="space-x-2 py-0.5" href="#">
            <img
              ...
              alt="Krum"
              className="border border-solid border-base-500 rounded-3xl w-5"
            ></img>
          </a>
          <a className="space-x-2 py-0.5" href="#">
            Krum
